...
CS_CZ = {
    ...
    "spl_3": "všechny soubory kromě obrázků byly ukládány do propojené složky Microsoft365 SharePoint Online. ",
...
EN_US = {
    ...
    "spl_2": "Our security policy requires that ",
    "spl_3": "all files except images are stored only to a connected folder on Microsoft365 SharePoint Online. ",
